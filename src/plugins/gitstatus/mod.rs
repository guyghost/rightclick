...
pub use plugin::{Command, GitPluginContext, GitStatusPlugin, PluginCommand, create_plugin, register_default_bindings};
...
pub fn create_with_config(
    config: crate::core::models::GitStatusPluginConfig,
) -> GitStatusPlugin {
